...
import { createAnimalProfile, getAnimalIdsByUserId, getAnimalProfilesByUserId, searchAnimalById } from '../Controller/AnimalProfile.js';
...
routes.get('/getanimalids/:userId', getAnimalIdsByUserId)
